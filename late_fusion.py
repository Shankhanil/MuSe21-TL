...
def main(args):
    ...
    if args.eval_model is None:  # Train and validate for each seed
        ...
        for seed in seeds:
            ...
            val_loss, val_score, best_model_file, best_model = train_model(args.task, model, data_loader, args.epochs, args.lr, args.paths['model'], seed, args.use_gpu, criterion)
            if not args.predict:
