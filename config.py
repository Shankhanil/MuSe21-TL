...
# OUTPUT_PATH = '/content/drive/MyDrive/reSensenetv2/results/'
# for sent-transfer learning
OUTPUT_PATH = 'results/'
# OUTPUT_PATH = '/content/drive/MyDrive/reSensenetv2/stress-TL-results/'

LOG_FOLDER = os.path.join(OUTPUT_PATH, 'log_muse')
TLDR_LOG_FOLDER = os.path.join(OUTPUT_PATH, 'tldr_log_muse')
